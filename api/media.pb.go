...
func (x *ComReturn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ComReturn) ProtoMessage() {}

func (x *ComReturn) ProtoReflect() protoreflect.Message {
	mi := &file_media_proto_msgTypes[0]
...
// Deprecated: Use ComReturn.ProtoReflect.Descriptor instead.
func (*ComReturn) Descriptor() ([]byte, []int) {
	return file_media_proto_rawDescGZIP(), []int{0}
}

func (x *ComReturn) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ComReturn) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_media_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x70,
	0x62, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x22, 0x39, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x52, 0x65, 0x74,
	0x75, 0x72, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x65, 0x42, 0x13, 0x5a, 0x11, 0x62, 0x6c, 0x75, 0x65, 0x70, 0x6c, 0x61, 0x6e, 0x65, 0x2f, 0x70,
	0x62, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_media_proto_goTypes = []interface{}{
	(*ComReturn)(nil), // 0: pbmedia.ComReturn
}
