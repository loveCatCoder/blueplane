...
/**
 * @file sdp_message.h
 * @brief sip SDP parser Routines
 *
 * This is the SDP accessor and parser related API.
 */

/**
 * @defgroup sip_SDP sip SDP parser Handling
 * @ingroup sip2_sdp
 * @{
 */
 ...
 */
	struct sdp_time_descr {
		...
		sip_list_t r_repeats;	  /**< repeat headers */
	};
 ...
 */
	struct sdp_media {
		...
		//char *m_fmt_list;
		/*****/
		sip_list_t m_fmt_list;/**< list of fmt (as strings) */
		/*****/
		sip_list_t m_payloads;/**< list of payloads (as strings) */

		char *i_info;			/**< information header */
		sip_list_t c_connections;
							   /**< list of sdp_connection_t * */
		sip_list_t b_bandwidths;
							   /**< list of sdp_bandwidth_t * */
		sip_list_t a_attributes;
 ...
 */
	struct sdp_message {
		...
		char *i_info;			/**< Information header */
		char *f_value;          /**< GB28181 f value*/ // for keda
		char *y_value;          /**< GB28181 ssrc value*/
        char *u_uri;			/**< Uri header */
		sip_list_t e_emails;  /**< list of mail address */
		sip_list_t p_phones;  /**< list of phone numbers * */
		sdp_connection_t *c_connection;
									  /**< Connection information */
		sip_list_t b_bandwidths;
							   /**< list of bandwidth info (sdp_bandwidth_t) */
		sip_list_t t_descrs;  /**< list of time description (sdp_time_descr_t) */
		char *z_adjustments;	/**< Time adjustment header */
		sdp_key_t *k_key;		/**< Key information header */
		sip_list_t a_attributes;
							   /**< list of global attributes (sdp_attribute_t) */
		sip_list_t m_medias;  /**< list of supported media (sdp_media_t) */
	};
 ...
 * @param value The token value.
 */
	int sdp_message_y_value_set(sdp_message_t * sdp, char *value);
/**
 * Get the session name ('s' field) of a SDP packet.
 * @param sdp The element to work on.
 */
 ...
 * @param sdp The element to work on.
 * @param pos_media The line number.
 * @param port The new port to set (must be allocated with sip_malloc)
 */
